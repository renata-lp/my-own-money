    ...
    <div className="step fade-in">
      ...
      <div className="cost-result">
        ...
        <div className="cr-row">
          ...
          <span className="cr-val warn">+{monthlyInterest} moneys</span>
        </div>
        <div className="cr-row big">
          <span>Interest added in one year</span>
          <span className="cr-val warn">+{yearlyInterest} moneys</span>
        </div>
  ...
  const spiralSteps = [
    {
      emoji: "💳",
      title: "Month 1",
      desc: "Someone spends 500 moneys on a credit card. They can only afford to pay 50 moneys. The remaining 450 carries over.",
      balance: 450,
      interest: 7.5,
    },
    {
    ...
    },
    {
      emoji: "😟",
      title: "Month 6",
      desc: "Despite paying 50 every month, the balance has barely moved — because interest keeps adding. They've paid 300 moneys and still owe nearly 400.",
      balance: 398,
      interest: 6.6,
    },
    {
        ...
        {current.balance && (
          <div className="sc-numbers">
            <div className="sc-num">
              ...
              <span className="sc-val warn">{current.balance} moneys</span>
            </div>
            <div className="sc-num">
              <span>Interest this month</span>
              <span className="sc-val warn">+{current.interest} moneys</span>
            </div>
          </div>
        )}
